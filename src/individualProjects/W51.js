...
import W51Rendering from '../W51/W51Rendering.jpg';

import { Link, Outlet } from "react-router-dom";

function W51({ loading, load }) {
            ...
            <div className="project-div">
                ...
                <div className="collage-div">
                    {
                        loading === true ?
                            ...
                            <div className="coming-soon">
                                ...
                                <img className="project-images" src={W51Rendering}></img>
                            </div>
                ...
                <div className="p-info-div">
                    ...
                    <div className="info-buttons-div">
                        <Link to="/W51unitA" style={{ color: 'white' }}>
                    ...
                    {/* <h5>{<Icon name='angle right' size='large' />}PLANS IN PROGRESS</h5> */}
                    <div className="info-buttons-div">
                        <Link to="/W51unitB" style={{ color: 'white' }}>
                            <Button variant="contained"
                                color="primary">
                                CLICK FOR DETAILS {<Icon name={buttonIcon} size='large' />}
                            </Button>
