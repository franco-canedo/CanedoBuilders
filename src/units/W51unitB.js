...
import floor1 from '../W51/unitBone.png';
import layout from '../W51/layout.png';
import Brendering from '../W51/51stADU.jpg';
            ...
            <div>
                ...
                <div className="unit-info-div-cont">
                    <div className="info-item">
                        <h2>1107 SF<Icon name='arrows alternate horizontal' size='large' /></h2>
                    </div>
                    <div className="info-item">
